...
// const result = calculatecardprice(200,300,400,500,600);

// console.log(result.val1,result.val2,...result.num1)
...
//       console.log(`username is ${anyobject.username} and doller is ${anyobject.prices}`)
// }
